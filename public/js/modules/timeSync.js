// NTP-inspired time synchronization between client and server.
// Replaces window.TimeSync from timeSync.js.
//
// Usage:
//   import { TimeSync } from '../js/modules/timeSync.js';
//   const ts = new TimeSync({ onOffsetUpdate: offset => ... });
